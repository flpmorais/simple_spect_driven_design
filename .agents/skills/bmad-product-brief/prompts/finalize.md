...
Update the product brief document at `{output_folder}/product-brief-{project_name}.md`:
...
**If yes, create the distillate** at `{output_folder}/product-brief-{project_name}-distillate.md`:
...
**Executive Brief:** `{output_folder}/product-brief-{project_name}.md`
[If distillate created:] **Detail Pack:** `{output_folder}/product-brief-{project_name}-distillate.md`
...
{
  "status": "complete",
  "brief": "{output_folder}/product-brief-{project_name}.md",
