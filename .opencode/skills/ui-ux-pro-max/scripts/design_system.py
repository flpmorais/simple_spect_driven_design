...
def generate_design_system(query: str, project_name: str = None, output_format: str = "ascii", 
    ...
    Args:
        ...
        persist: If True, save design system to _bmad-output/design-system/ folder
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    """
    Persist design system to _bmad-output/design-system/<project>/ folder using Master + Overrides pattern.
    ...
    design_system_dir = base_dir / "_bmad-output" / "design-system" / project_slug
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    lines.append("> **LOGIC:** When building a specific page, first check `_bmad-output/design-system/<project>/pages/[page-name].md`.")
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    lines.append("")
    lines.append("> ⚠️ **IMPORTANT:** Rules in this file **override** the Master file (`_bmad-output/design-system/<project>/MASTER.md`).")
